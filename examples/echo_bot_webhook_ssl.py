...
from aiogram_max.types import FSInputFile, Message
from aiogram_max.utils.markdown import hbold
...
def main() -> None:
    ...
    web.run_app(
        app, host=WEB_SERVER_HOST, port=WEB_SERVER_PORT, ssl_context=context
    )
