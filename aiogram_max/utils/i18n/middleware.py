...
from aiogram_max.types import TelegramObject, User
from aiogram_max.utils.i18n.core import I18n
...
class I18nMiddleware(BaseMiddleware, ABC):
    ...
    async def __call__(
        ...
        current_locale = (
            await self.get_locale(event=event, data=data)
            or self.i18n.default_locale
        )
...
class SimpleI18nMiddleware(I18nMiddleware):
    ...
    def __init__(
        ...
        super().__init__(
            i18n=i18n, i18n_key=i18n_key, middleware_key=middleware_key
        )
