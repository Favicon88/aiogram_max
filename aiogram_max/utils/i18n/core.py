...
from aiogram_max.utils.i18n.lazy_proxy import LazyProxy
from aiogram_max.utils.mixins import ContextInstanceMixin
...
class I18n(ContextInstanceMixin["I18n"]):
    def __init__(
        ...
        *,
        ...
        self.domain = domain
        self.ctx_locale = ContextVar(
            "aiogram_ctx_locale", default=default_locale
        )
