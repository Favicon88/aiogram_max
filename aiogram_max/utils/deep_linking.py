...
from aiogram_max.utils.link import create_telegram_link
from aiogram_max.utils.payload import decode_payload, encode_payload
...
def create_deep_link(
    ...
    if not app_name:
        deep_link = create_telegram_link(
            username, **{cast(str, link_type): payload}
        )
    else:
        deep_link = create_telegram_link(
