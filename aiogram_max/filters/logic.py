...
from aiogram_max.filters import Filter

if TYPE_CHECKING:
    from aiogram_max.dispatcher.event.handler import CallbackType, FilterObject
...
def and_f(*targets: "CallbackType") -> _AndFilter:
    from aiogram_max.dispatcher.event.handler import FilterObject
