...
from aiogram_max.exceptions import (
    ClientDecodeError,
    RestartingTelegram,
    TelegramAPIError,
    TelegramBadRequest,
...
from ...methods import Response, TelegramMethod, MaxResponse
