...
if TYPE_CHECKING:
    ...
    from aiogram_max.dispatcher.event.handler import HandlerObject
    from aiogram_max.dispatcher.middlewares.user_context import EventContext
    from aiogram_max.fsm.context import FSMContext
    from aiogram_max.fsm.storage.base import BaseStorage
    from aiogram_max.types import Chat, Update, User
    from aiogram_max.utils.i18n import I18n, I18nMiddleware
